 ...
 <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Activate Geofence</h6>
                        <a class="collapse-item" href="geofence.php">Activate Geofence</a>
                        <div class="collapse-divider"></div>
                        <h6 class="collapse-header">Show Incoming Trucks</h6>
                        <a class="collapse-item" href="blank.php">Incoming Trucks</a>
                    </div>
                </div>
            </li>
