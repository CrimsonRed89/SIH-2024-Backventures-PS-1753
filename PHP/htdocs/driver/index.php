...
<head>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDrF8zFKWIDqUqVRvBueIWN5Ib70ga3hUc&callback=initMap"></script>
...
<body class="theme-light" data-highlight="highlight-red" data-gradient="body-default">
    ...
    <div id="page">
        <div id="footer-bar" class="footer-bar-1">
          ...
          <a href="inventory"><i class="fa fa-star"></i><span>Features</span></a> 
        ...
        <div id="menu-cookie-modal" class="menu menu-box-modal menu-box-round-medium menu-box-detached rounded-s"
            ...
            <div class="px-3 text-center">
                ...
                <p style="margin-top: -10px;">
                    By clicking "Go online" you'll be active<br> to receive a trip from warehouse.
                </p>
        ...
        <div id="menu-cookie-modal-offline" class="menu menu-box-modal menu-box-round-medium menu-box-detached rounded-s"
            ...
            <div class="px-3 text-center">
                ...
                <p style="margin-top: -10px;">
                    By clicking "Go offline" you'll be Inactive<br> to a trip from warehouse.
                </p>
        ...
        <div class="page-content header-clear-small">
            ...
            <div class="card card-style mb-3 bg-danger">
                <div class="content mt-3 mb-0">
                    <h1 class="text-center animated-silver">Your Current Location</h1>
                </div>
            </div>
            <?php } ?>
            ...
            <div class="card card-style mb-3">
                <div class="content mt-3 mb-0">
                    <div class="container">
                        <div class="column mt-1">
                            <span style="font-size: x-large;font-weight: bold;">Trip Received</span>
                        </div>
                        <div class="column">
            ...
            <div id="ad-timed-2" class="menu menu-box-modal menu-box-modal-full">
                <div class="card m-0 bg-17" style="height:100vh; width:100vw;">
                    ...
                    <div class="card-top no-click">
                        <span class="color-white bg-black font-10 opacity-70 pb-1 pt-1 ps-2 pe-2 ms-1"></span>
                    </div>
                    <div class="card-center ms-5 me-5">
                        <h1 class="color-white text-center mb-3 font-40">New Trip!</h1>
                        <div class="content mt-3 mb-0">
            ...
            <div id="ad-reach-shop" class="menu menu-box-modal menu-box-modal-full">
                ...
                <div class="card m-0 bg-17" style="height:100vh; width:100vw;">
                    ...
                    <div class="card-center ms-5 me-5">
                        <h1 class="color-red-light text-center mb-3 font-20">Warehouse Details</h1> 
                        <div class="content mt-3 mb-0 color-white">
                            <div class="containercopy">
                                <div class="column" >
                                    <span class="color-red-light" style="font-size: x-small;font-weight:normal;">Warehouse Name</span>
                                    <br>
                                    <span style="font-size: x-small;font-weight: bold;"><?php echo $rowe['shopName']; ?></span>
                                </div>
                                <hr style="border-left: 1px solid lightblue;height: 100px;">
                                <div class="column" >
                                    <span class="color-red-light" style="font-size: x-small;font-weight:normal;">Warehouse Address</span>
                                    <br>
                                    <span style="font-size:x-small;font-weight: bold;"><?php echo $rowe['shopAddress']; ?></span>
                                </div>
                            </div>
                            <div class="containercopy">
                                <div class="column" >
                                    <span class="color-red-light" style="font-size: x-small;font-weight:normal;">Warehouse Email</span>
                                    <br>
                                    <span style="font-size: x-small;font-weight: bold;"><?php echo $rowe['shopEmail']; ?></span>
                                </div>
                                <hr style="border-left: 1px solid lightblue;height: 100px;">
                                <div class="column" >
                                    <span class="color-red-light" style="font-size: x-small;font-weight:normal;">Warehouse Contacts</span>
                                    <br>
                    ...
                    <div class="card-bottom mb-4">
                        <center>
                            <form action="driverController/manage-status.php" method="POST">
                                <input type="hidden" name="orderDetailID" value="<?php echo $rowts['orderDetailID']; ?>">
                                <button class="ml-3 me-3 ms-3 mt-5 btn btn-m shadow-xl text-uppercase font-50 bg-green-dark" name="reachShop">Reached Origin Warehouse</button>
                            </form>
                        </center>
                    </div>
                    <div class="card-overlay bg-black opacity-90"></div>
            ...
            <div id="ad-pick-order" class="menu menu-box-modal rounded-m">
                <div class="card mb-0 bg-17" data-card-height="300">
                    ...
                    <div class="card-center ms-2 me-2">
                        <h1 class="color-white text-center mb-3">Start Trip</h1>
                        <p class="color-white text-center opacity-50 mt-n1 mb-0">Click on "Start Trip" to mark Trip Startd.</p>
                        <center>
                            <form action="driverController/manage-status.php" method="POST">
                                <input type="hidden" name="orderDetailID" value="<?php echo $rowts['orderDetailID']; ?>">
                                <button class="ml-3 me-3 ms-3 mt-5 btn btn-m rounded-s shadow-xl text-uppercase font-50 bg-green-dark" name="picked">Start Trip</button>
                            </form>
                        </center>
                    </div>
                    <div class="card-overlay bg-black opacity-90"></div>
            ...
            <div id="ad-reach-drop" class="menu menu-box-modal menu-box-modal-full">
                <div class="header header-fixed header-logo-center">
                    <a href="index.php" class="header-title">Reach Warehouse</a>
                    <a href="index.php" class="header-icon header-icon-1"><i class="fas fa-arrow-left"></i></a>
                    <a href="#" class="close-menu no-click ad-time-close color-highlight"><i
                                class="fa fa-times disabled"></i><span></span></a>
                </div>
                <div class="card m-0 bg-17" style="height:100vh; width:100vw;">
                    ...
                    <div class="card-bottom mb-4">
                        <center>
                            <form action="driverController/manage-status.php" method="POST">
                                <input type="hidden" name="orderDetailID" value="<?php echo $rowts['orderDetailID']; ?>">
                                <button class="ml-3 me-3 ms-3 mt-5 btn btn-m shadow-xl text-uppercase font-50 bg-green-dark" name="reachDrop">Reached Destinated Warehouse</button>
                            </form>
                        </center>
                    </div>
                    <div class="card-overlay bg-black opacity-90"></div>
            ...
            <div id="ad-deliveried-order" class="menu menu-box-modal rounded-m">
                <div class="card mb-0 bg-17" data-card-height="300">
                    ...
                    <div class="card-center ms-2 me-2">
                        <h1 class="color-white text-center mb-3">Complete Trip</h1>
                        <p class="color-white text-center opacity-50 mt-n1 mb-0">Click on "Complete Trip"<br> to confirm Trip Completed.</p>
                        ...
                        <center>
                            <button data-menu="menu-cookie-deliveried" class="ml-3 me-3 ms-3 mt-5 btn btn-m rounded-s shadow-xl text-uppercase font-50 bg-green-dark" >Mark Trio Completed</button>
                        </center>
                    </div>
                    <div class="card-overlay bg-black opacity-90"></div>
                </div>
            ...
            <div id="menu-cookie-deliveried" class="menu menu-box-modal menu-box-round-medium menu-box-detached rounded-s" data-menu-height="250" data-menu-width="310" data-menu-effect="menu-over" data-menu-select="page-components">
                <div class="px-3 text-center">
                    <h1 class="text-center mt-4 mb-0">Are you sure? </h1>
                    <p class="text-center font-12 color-highlight" style="margin-top: -30px;">Trip Completed</p>
                    <p style="margin-top: -10px;">
                        By clicking "Yes! Im sure" Trip will be marked Completed.
                    </p>
